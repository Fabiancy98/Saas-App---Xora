    ...
    <div className="relative z-2 mb-16">
      ...
      >
        <div className="flex-1">
          ...
          <div
            className={clsx(
              "h6 text-p4 transition-colors max-md:flex max-md:min-h-20 max-md:items-center",
              active && "lg:text-p1"
            )}
          >
            {faq.question}
        ...
        <div
          className={clsx(
            "faq-icon relative flex size-12 items-center justify-center rounded-full border-2 border-s2 shadow-400 transition-all dur group-hover:border-s4",
